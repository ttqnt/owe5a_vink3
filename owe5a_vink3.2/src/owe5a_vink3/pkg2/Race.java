...
public class Race extends JFrame implements ActionListener {
    ...
    private void startRace(Graphics g) {
         ...
         * kunt initialiseren.
         */
    	h1 = new Paard("Blauw", Color.blue);
    	h2 = new Paard("Zwart", Color.black);
    	h3 = new Paard("Grijs", Color.gray);
    	h4 = new Paard("Rood", Color.red);
    	h5 = new Paard("Cyan", Color.cyan);
    	
    	h1.setImg("/home/karin/NetBeansProjects/owe5a_vink3.2/build/classes/owe5a_vink3/pkg2/blauw.png");
    	h2.setImg("/home/karin/NetBeansProjects/owe5a_vink3.2/build/classes/owe5a_vink3/pkg2/zwart.png");
    	h3.setImg("/home/karin/NetBeansProjects/owe5a_vink3.2/build/classes/owe5a_vink3/pkg2/grijs.png");
    	h4.setImg("/home/karin/NetBeansProjects/owe5a_vink3.2/build/classes/owe5a_vink3/pkg2/rood.png");
    	h5.setImg("/home/karin/NetBeansProjects/owe5a_vink3.2/build/classes/owe5a_vink3/pkg2/cyan.png");
         ...
         */
        if (h1.getAfstand() >= lengte && h1.getAfstand() > h2.getAfstand() && h1.getAfstand() > h3.getAfstand() && h1.getAfstand() > h4.getAfstand() && h1.getAfstand() > h5.getAfstand() ) {
            JOptionPane.showMessageDialog(null, h1.getNaam() + " gewonnen!");
        }
        if (h2.getAfstand() >= lengte && h2.getAfstand() > h1.getAfstand() && h2.getAfstand() > h3.getAfstand() && h2.getAfstand() > h4.getAfstand() && h2.getAfstand() > h5.getAfstand() ) {
            JOptionPane.showMessageDialog(null, h2.getNaam() + " gewonnen!");
        }
        if (h3.getAfstand() >= lengte && h3.getAfstand() > h1.getAfstand() && h3.getAfstand() > h2.getAfstand() && h3.getAfstand() > h4.getAfstand() && h3.getAfstand() > h5.getAfstand()) {
            JOptionPane.showMessageDialog(null, h3.getNaam() + " gewonnen!");
        }
        if (h4.getAfstand() >= lengte && h4.getAfstand() > h1.getAfstand() && h4.getAfstand() > h2.getAfstand() && h4.getAfstand() > h3.getAfstand() && h4.getAfstand() > h5.getAfstand()) {
            JOptionPane.showMessageDialog(null, h4.getNaam() + " gewonnen!");
        }
        if (h5.getAfstand() >= lengte && h5.getAfstand() > h1.getAfstand() && h5.getAfstand() > h2.getAfstand() && h5.getAfstand() > h3.getAfstand() && h5.getAfstand() > h4.getAfstand()) {
    ...
    private void tekenPaard(Graphics g, Paard h) {
	    g.drawImage(h.getImg(), h.getAfstand(), 30 * h.getPaardNummer(), null);
		g.setColor(Color.white);
		g.fillRect(h.getAfstand()-30, 30 * h.getPaardNummer(), 30, 30);
